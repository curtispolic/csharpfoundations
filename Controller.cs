            ...
            foreach (var arg in args)
            {
                switch (arg)
                {
                    ...
                    case "2":
                        ...
                        Console.WriteLine("\n--------------------\n\nBelow is the output for the 2-1 CallMethodsFromDotnetLibrary module:");
                        CallMethodsFromDotnetLibrary.Run();

                        Console.WriteLine("\n--------------------\n\nBelow is the output for the 2-2 DecisionLogic module:");
                        DecisionLogic.Run();

                        Console.WriteLine("\n--------------------\n\nBelow is the output for the 2-3 StoreAndIterateOverArrays module:");
                        StoreAndIterateOverArrays.Run();

                        Console.WriteLine("\n--------------------\n\nBelow is the output for the 2-4 ForeachAndIfElseStructures module:");
                        ForeachAndIfElseStructures.Run();

                        Console.WriteLine("\n--------------------\n\nBelow is the output for the 2-5 FurtherForeachAndIfElseStructures module:");
